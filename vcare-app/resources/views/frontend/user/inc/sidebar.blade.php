  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex ">
      <div class="info text-center">
        ...
        <a href="{{ route('user.dashboard') }}" class="d-block text-light">{{ ucwords($settings['site_name']) }} <br>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <!-- START Booked -->
        <li class="nav-item">
          <a href="{{ route('user.Booked') }}" class="nav-link @if (request()->routeIs('user.Booked')) active @endif">
        ...
        <!-- START MESSAGES -->
        <li class="nav-item">
          <a href="{{ route('indexMajor') }}" class="nav-link">
          <i class="far fa-comments m-1"></i>
            <p>
                {{ strtoupper('Book an appointment') }}
            </p>
          </a>
        </li>
        <!-- END MESSAGES -->
