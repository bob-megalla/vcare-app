...
if (!empty($_SESSION['user_id'])): ?>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <?php endif; ?>
            <form role="form" method="POST" action="?admin=StoreEditUser" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group">
                        <label for="name">Full Name</label>
                        <input type="text" class="form-control" id="name" placeholder="Enter Full Name"
                            name="name" value="<?=$allUsers["name"]?>">
                            <input type="text" style="display:none" class="form-control" id="id" placeholder="Enter Full id"
                            name="id" value="<?=$allUsers["id"]?>">
                    </div>
                    <div class="form-group">
                        <label for="phone">Phone</label>
                        <input type="text" class="form-control" id="phone" placeholder="Enter Phone"
                            name="phone" value="<?=$allUsers["phone"]?>">
                    </div>
                    <div class="form-group">
