...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('doctor.logout') }}" class="nav-link">Logout</a>
        </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                @php
                    $unreaded_messages = App\Models\BookedDoctor::where('is_compeleted', '0')
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <a href="{{ route('doctor.changeStatusBookedRead',$msg->id) }}" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                    ...
                    @endforeach
                    <div class="dropdown-divider"></div>
                    <a href="{{ route('doctor.BookedDoctor') }}" class="dropdown-item dropdown-footer">See All Booked</a>
                </div>
